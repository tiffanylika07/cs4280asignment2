...
<html>
    ...
    <form class="form-horizontal" method="POST" action="./AdminController?action=editBook">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="price"  name="Price" value="<%=aBook.getPrice()%>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="loyalty" name="Loyalty_Points" value="<%=aBook.getLoyalty_Point()%>">
                </div>
            </div>
            <div class="form-group">
